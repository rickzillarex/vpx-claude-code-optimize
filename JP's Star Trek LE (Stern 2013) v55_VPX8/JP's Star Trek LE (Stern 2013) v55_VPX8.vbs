...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Star Trek LE - Stern 2013" & vbNewLine & "VPX table by JPSalas 5.5.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub table1_KeyDown(ByVal Keycode)
    ...
    If keycode = LeftMagnaSave Then Controller.Switch(71) = 1: bLutActive = True: SetLUTLine "Color LUT image " & table1.ColorGradeImage
...
Sub table1_KeyUp(ByVal Keycode)
    ...
    If keycode = LeftMagnaSave Then Controller.Switch(71) = 0: bLutActive = False: HideLUT
...
'Flashers
SolCallback(17) = "SetLamp 517,"
SolCallback(18) = "SetLamp 518,"
SolCallback(19) = "SetLamp 519,"
SolCallback(20) = "SetLamp 520,"
SolCallback(21) = "SetLamp 521,"
SolCallback(23) = "SetLamp 523,"
SolCallback(25) = "SetLamp 525,"
SolCallback(26) = "SetLamp 526,"
SolCallback(27) = "SetLamp 527,"
SolCallback(28) = "SetLamp 528,"
SolCallback(29) = "SetLamp 529,"
SolCallback(30) = "SetLamp 530,"
SolCallback(31) = "SetLamp 531,"
SolCallback(32) = "SetLamp 532,"
SolCallback(59) = "SetLamp 541,"
'backdrop flashers
SolCallback(60) = "SetLamp 560," 'x2
SolCallback(61) = "SetLamp 561," 'x2
SolCallback(62) = "SetLamp 562,"
SolCallback(63) = "SetLamp 563,"
SolCallback(64) = "SetLamp 564,"
...
Sub LampTimer_Timer()
    ...
    If Not IsEmpty(chgLamp)Then
        For ii = 0 To UBound(chgLamp)
			...
			'Select Case chgLamp(ii, 0)					'Check if GI light needs to be changed
			'	Case 9:	If chgLamp(ii, 1) = 1 then ChangeGi blue
			'	Case 15:If chgLamp(ii, 1) = 1 then ChangeGi red
			'	Case 10:If chgLamp(ii, 1) = 1 then ChangeGi yellow
			'	Case 14:If chgLamp(ii, 1) = 1 then ChangeGi teal
			'	Case 16:If chgLamp(ii, 1) = 1 then ChangeGi darkblue
			'	Case 11:If chgLamp(ii, 1) = 1 then ChangeGi green
			'End Select
        Next
    End If
    UpdateLamps
