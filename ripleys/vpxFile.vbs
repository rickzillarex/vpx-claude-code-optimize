...
Sub RightFlipper1_Animate
    ...
    If a <> lastRF1Angle Then lastRF1Angle = a : RightFlipperTop1.RotZ = a
End Sub
...
Sub LeftFlipper_Timer 'flipper's tricks timer
    ' Cache COM reads for left flipper
...
'End Of Stroke Routine : Livecatch and Emply/Full-Charged EOS
    ...
    ' Cache COM reads for right flipper
...
' Pre-computed inverse multipliers for Pan/AudioFade (eliminates division per call)
...
' Pre-built string array for ball rolling sounds (eliminates per-frame concatenation)
