...
'   - Cache table1.width/height into TableWidth/TableHeight module-level variables
' ======================================================================
...
Function AudioPan(tableobj) ' Calculates the pan for a tableobj based on the X position on the table. "table1" is the name of the table
    ...
    If tmp > 0 Then
        Dim ap2, ap4, ap8 : ap2 = tmp*tmp : ap4 = ap2*ap2 : ap8 = ap4*ap4 : AudioPan = Csng(ap8*ap2)
    Else
        Dim ap2n, ap4n, ap8n : ap2n = tmp*tmp : ap4n = ap2n*ap2n : ap8n = ap4n*ap4n : AudioPan = Csng(-(ap8n*ap2n))
    End If
End Function

Function Vol(ball) ' Calculates the Volume of the sound based on the ball speed
    Vol = Csng(BallVel(ball) * BallVel(ball) / 5000)
End Function
...
Dim BallRollStr() : ReDim BallRollStr(6)
Dim ii_brs : For ii_brs = 0 To 6 : BallRollStr(ii_brs) = "fx_ballrolling" & ii_brs : Next
