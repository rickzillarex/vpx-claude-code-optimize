...
'   5. Table width/height already cached (TableWidth/TableHeight)
'   6. Pre-built rolling sound string array
'   7. Flipper timer 1ms -> 10ms for FlipperTricks
'   8. Cache flipper COM props (CurrentAngle) in LeftFlipper_Timer
' ============================================================
...
LeftFlipper.TimerInterval = 10  ' OPT: was 1ms, 10ms is sufficient for flipper tricks
LeftFlipper.TimerEnabled = 1

Sub LeftFlipper_Timer 'flipper's tricks timer
    ' OPT: Cache COM properties for both flippers
    Dim LFAngle : LFAngle = LeftFlipper.CurrentAngle
    Dim RFAngle : RFAngle = RightFlipper.CurrentAngle

'Start Of Stroke Flipper Stroke Routine : Start of Stroke for Tap pass and Tap shoot
    If LFAngle >= LeftFlipper.StartAngle - SOSAngle Then LeftFlipper.Strength = FlipperPower * SOSTorque else LeftFlipper.Strength = FlipperPower : End If

'End Of Stroke Routine : Livecatch and Emply/Full-Charged EOS
	If LeftFlipperOn = 1 Then
		If LFAngle = LeftFlipper.EndAngle then
...
'Start Of Stroke Flipper Stroke Routine : Start of Stroke for Tap pass and Tap shoot
    If RFAngle <= RightFlipper.StartAngle + SOSAngle Then RightFlipper.Strength = FlipperPower * SOSTorque else RightFlipper.Strength = FlipperPower : End If

'End Of Stroke Routine : Livecatch and Emply/Full-Charged EOS
 	If RightFlipperOn = 1 Then
		If RFAngle = RightFlipper.EndAngle Then
...
Dim brs_i
For brs_i = 0 To 19 : BallRollStr(brs_i) = "fx_ballrolling" & brs_i : Next
