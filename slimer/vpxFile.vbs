...
'  2. Cached flipper COM properties (CurrentAngle, StartAngle, EndAngle)
...
'  6. Pre-built rolling sound string array (BallRollStr)
'  7. Cached ball COM properties in rolling loop (VelX, VelY, z, x, y)
' *********************************************************************
'DOF by Arngrim
...
Sub RotateLaneLightsLeft()
    Dim tmp
    tmp = l28.State
    l28.state = l29.State:l28b.State = l29.State:Bumper1Light.State = l29.State
    l29.State = l30.State:l29b.State = l30.State:Bumper2Light.State = l30.State
    l30.State = tmp:l30b.State = tmp:Bumper3Light.State = tmp
End Sub

Sub RotateLaneLightsRight()
    Dim tmp
    tmp = l30.State
    l30.State = l29.State:l30b.State = l29.State:Bumper3Light.State = l29.State
    l29.State = l28.State:l29b.State = l28.State:Bumper2Light.State = l28.State
    l28.State = tmp:l28b.State = tmp:Bumper1Light.State = tmp
End Sub
...
Sub FlashEffectTimer_Timer()
    Select Case FEffect
        Case 1
            ...
            FlashForms LeftRampDome1a, 2000, 40, 0
            FlashForms LeftRampDome2a, 2000, 40, 0
            DOF 209, DOFPulse
            FlashForms StayPuftFlasher, 2000, 40, 0
            FlashForms ectoFlasher, 2000, 40, 0
            FlashForms LibraryFlasher1, 2000, 40, 0
            FlashForms LibraryFlasher2, 2000, 40, 0
            DOF 207, DOFPulse
            FlashForms BooksFlasher, 2000, 40, 0
            FlashForms ContainerFlasher001, 2000, 40, 0:FlashForms ContainerFlasher002, 2000, 40, 0:DOF 203, DOFPulse
            FlashForms Protonflasher, 2000, 40, 0
            FlashForms l5, 2000, 40, 0
            FlashForms l6, 2000, 40, 0
            FlashForMs FirestationFlasher2, 2000, 40, 0
        ...
        Case 2
            Select Case INT(RND * 14)
                Case 0:FlashForms LeftRampDome1, 1000, 40, 0:FlashForms LeftRampDome1a, 1000, 40, 0
                Case 1:FlashForms LeftRampDome2, 1000, 40, 0:FlashForms LeftRampDome2a, 1000, 40, 0
                    DOF 210, DOFPulse
                Case 2:FlashForms l5, 1000, 40, 0
                Case 3:FlashForms l6, 1000, 40, 0
                Case 4:FlashForms StayPuftFlasher, 1000, 40, 0
                Case 5:FlashForms ectoFlasher, 1000, 40, 0
                Case 6:FlashForms LibraryFlasher1, 1000, 40, 0:FlashForms LibraryFlasher2, 1000, 40, 0
                    DOF 206, DOFPulse
                Case 7:FlashForms BooksFlasher, 1000, 40, 0
                Case 8:FlashForms ContainerFlasher001, 1000, 40, 0:FlashForms ContainerFlasher002, 1000, 40, 0:DOF 204, DOFPulse
                ...
                Case 13:FlashForMs FirestationFlasher2, 1000, 40, 0
            End Select
            If FEStep = 20 then FlashEffectTimer.Enabled = 0
        Case 3
            Select case FEStep
                Case 0:FlashForms LeftRampDome1, 250, 40, 0:FlashForms LeftRampDome1a, 250, 40, 0:FlashForms LeftRampDome2, 250, 40, 0:FlashForms LeftRampDome2a, 250, 40, 0:DOF 211, DOFPulse:FlashForms StayPuftFlasher, 250, 40, 0
                Case 1:FlashForms ectoFlasher, 250, 40, 0:FlashForms LibraryFlasher1, 250, 40, 0:FlashForms LibraryFlasher2, 250, 40, 0:DOF 208, DOFPulse:FlashForms BooksFlasher, 250, 40, 0
                Case 2:FlashForms ContainerFlasher001, 250, 40, 0:FlashForms ContainerFlasher002, 250, 40, 0:DOF 205, DOFPulse:FlashForms Protonflasher, 250, 40, 0
                Case 3:FlashForms l5, 250, 40, 0:FlashForms l6, 250, 40, 0
                Case 4:FlashForms LeftRampDome1, 250, 40, 0:FlashForms LeftRampDome1a, 250, 40, 0:FlashForms LeftRampDome2, 250, 40, 0:FlashForms LeftRampDome2a, 250, 40, 0:DOF 211, DOFPulse:FlashForms StayPuftFlasher, 250, 40, 0
                Case 5:FlashForms ectoFlasher, 250, 40, 0:FlashForms LibraryFlasher1, 250, 40, 0:FlashForms LibraryFlasher2, 250, 40, 0:DOF 208, DOFPulse:FlashForms BooksFlasher, 250, 40, 0
                Case 6:FlashForms ContainerFlasher001, 250, 40, 0:FlashForms ContainerFlasher002, 250, 40, 0:DOF 205, DOFPulse:FlashForms Protonflasher, 250, 40, 0
                Case 7:FlashForms l5, 250, 40, 0:FlashForms l6, 250, 40, 0
                Case 8:FlashForms LeftRampDome1, 250, 40, 0:FlashForms LeftRampDome1a, 250, 40, 0:FlashForms LeftRampDome2, 250, 40, 0:FlashForms LeftRampDome2a, 250, 40, 0:DOF 211, DOFPulse:FlashForms StayPuftFlasher, 250, 40, 0
                Case 9:FlashForms ectoFlasher, 250, 40, 0:FlashForms LibraryFlasher1, 250, 40, 0:FlashForms LibraryFlasher2, 250, 40, 0:DOF 208, DOFPulse:FlashForms BooksFlasher, 250, 40, 0
                Case 10:FlashForms ContainerFlasher001, 250, 40, 0:FlashForms ContainerFlasher002, 250, 40, 0:DOF 205, DOFPulse:FlashForms Protonflasher, 250, 40, 0
                Case 11:FlashForms l5, 250, 40, 0:FlashForms l6, 250, 40, 0
    ...
    For b = lob to UBound(BOT)
        ...
        If bvel > 1 Then
            ...
            Else
                ...
                ballvol = Csng((bvx*bvx + bvy*bvy) / 2000) * 5
            End If
            rolling(b) = True
...
Sub HighScoreEntryInit()
    ...
    hsValidLetters = " ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789<" ' < is back arrow to delete the last letter
    hsCurrentLetter = 1
    DMDFlush()
...
Sub DMDInit
    ...
    BumpS(2)  = "  SCOLERI BROTHERS"
    BumpS(3)  = "  SCOLERI BROTHERS"
    BumpS(4)  = "   LIT 3 GHOSTS"
    BumpS(5)  = "   LIT 2 GHOSTS"
    BumpS(6)  = "LIT STORAGE FACILITY"
    BumpS(7)  = "  LIT PLAYFIELD X "
    BumpS(8)  = " EXTRA BALL IS LIT"
    BumpS(9)  = " INC SUPER JACKPOT"
    BumpS(10) = " INC SPINNER LEVEL"
    BumpS(11) = " INC SPINNER VALUE"
    BumpS(12) = "  CATCH 3 GHOSTS"
    BumpS(13) = "  CATCH 2 GHOSTS"
    BumpS(14) = "   CATCH 1 GHOST"
    BumpS(15) = " BUMP SPINNER VALUE"
    BumpS(16) = "    BONUS HELD"
    BumpS(17) = "   BIGGER POINTS"
    BumpS(18) = "    BIG POINTS"
    BumpS(19) = "   AWARD SPECIAL"
    BumpS(20) = " ADV SPINNER LEVEL"
    BumpS(21) = "   ADV BONUS 3X"
    BumpS(22) = "   ADV BONUS 1X"
    BumpS(23) = "     ADD TIME"
    BumpS(24) = "  LIT ADD A BALL"
    BumpS(25) = "  +300 PKE LEVEL"
    BumpS(26) = "  +100 PKE LEVEL "
    BumpS(27) = "  +3 BONUS X"
    BumpS(28) = "  +2 BONUS X"
    BumpS(29) = "  +1 BONUS X"
 End Sub
...
Sub StartLightSeq()
    ...
    LightSeqAttract.Play SeqRandom, 20, , 4000
...
Sub Game_Init() 'called at the start of a new game
    ...
    ContainerFlasher1. State = 0
    ContainerFlasher2. State = 0
    ContainerFlasher3. State = 0
    ContainerFlasher4. State = 0
    ContainerFlasher5. State = 0
    ContainerFlasher6. State = 0
End Sub
...
Sub UpdateSkillShot() 'Updates the DMD & lights with the chosen skillshots
    LightSeqSkillshot.Play SeqAllOff
    'turn off lights
    l28.State = 0:l28b.State = 0:Bumper1Light. State = 0
    l29.State = 0:l29b.State = 0:Bumper2Light. State = 0
    l30.State = 0:l30b.State = 0:Bumper3Light. State = 0
    l60.State = 0
    l61.State = 0
    l62.State = 0
    l63.State = 0
...
Sub LeftRampDone_Hit()
    ...
    FlashForms LeftRampDome1a, 1000, 40, 0
    FlashForms LeftRampDome2a, 1000, 40, 0
    DOF 210, DOFPulse
...
Sub Bumper1_Hit
    ...
    AddScore 500 + 4500 * ABS(Bumper1Light.State) 'a bumper scores 500 points and 5000 points when lit
...
Sub Bumper2_Hit
    ...
    DOF 110, DOFPulse
    FlashForMs BumperFlash, 500, 50, 0:FlashForMs BumperFlash1, 500, 50, 0
    AddScore 500 + 4500 * ABS(Bumper1Light.State) 'a bumper scores 100 points and 1000 points when lit
...
BumpAward = Array( "BONUS2","SPIRIT"," DOG ", "SCOLER", "SMALLP", "3GHOST", "2GHOST", "STORAG", " 2X ", " XBALL", "+JACKP", "+SPINL", "+SPINV", "CATCH3",_
 "CATCH2", "CATCH1", " 3X ", "BONUS+", "BIGGRP", " BIGP ", "SPECIAL", "BONUS3", "BONUS1", " TIME+", "MULTIB", " PKE+3", " PKE+1")

Sub CheckBumpers()
    ' 1st display the awards
    Dim tmp
    tmp = BumpAward(b1) & "*" & BumpAward(b2) & "*" & BumpAward(b3)
	DMDFlush
    DMD "    BUMPER AWARD", tmp, "", eNone, eNone, eNone, 1000, True, ""
...
Sub GiveBumperAward()
        DMD "    BUMPER AWARD", BumpS(b1), "", eNone, eBlinkFast, eNone, 2000, True, "gb_fanfare5"
    Select Case b1
        Case 0:AddBonusMultiplier 2      '+2 Bonus X
        ...
        Case 4:AddScore INT(RND * 5 + 1) * 50000                   'Small Points
        ...
        Case 8:Enable2XMultiplier             'Light Playfield Multipliers
        ...
        Case 16:Enable3XMultiplier                '3x playfield multiplier
        ...
        Case 21:AddBonusMultiplier 3                              'Advance Bonus X by 3X
        Case 22:AddBonusMultiplier 1                              'Advance Bonus X by 1X
        Case 23:AddTime                                           'Add Time
        Case 24                                                   'Lit Add A Ball
            If bMultiBallMode Then
                AddMultiball 1
            Else
                l57.State = 2
            End If
        Case 25:PKELevel = PKELevel + 300 '+300 PKE Level
        Case 26:PKELevel = PKELevel + 100 '+100 PKE Level
    End Select
...
Sub FlashLeftScoop
    FlashForms l5, 1000, 40, 0
    FlashForms LibraryFlasher1, 1000, 40, 0
    FlashForms LibraryFlasher2, 1000, 40, 0
    DOF 206, DOFPulse
End Sub
...
Sub LeftScoopExit
	...
	leftScoopk.Rotx = -10
	vpmtimer.addtimer 150, "leftScoopK.Rotx = 0 '"
End Sub
...
Sub RightScoopExit
	...
	RightScoopk.Rotx = -10
	vpmtimer.addtimer 150, "RightScoopk.Rotx = 0 '"
End Sub
...
Sub StartSFM() 'Multiball
    ...
    LitAllGhosts
    StartRainbow "gi"
    FlashForms ContainerFlasher001, 2000, 40, 1:FlashForms ContainerFlasher002, 2000, 40, 1:DOF 203, DOFPulse
    AddMultiball 3
End Sub

Sub StorageLockExit()
    StorageLock.Kick 0, 30, 1.56
    DOF 141, DOFPulse
End Sub
...
Sub GozerHurryUp_Timer()
    ...
    FlashForms LeftRampDome2a, 1000, 50, 0
    DOF 212, DOFPulse
...
'****************************************************
' Mini Wizard Mode 2 (11): We are Ready to Believe You
'****************************************************
