...
'   7. Eliminated ^3 in VolPlayfieldRoll
'   8. Eliminated ^2 in PitchPlayfieldRoll
'   9. Flipper timer 1ms -> 10ms for FlipperTricks
' ============================================================
' ****************************************************************
...
RightFlipper.timerinterval=10  ' OPT: was 1ms, 10ms is sufficient for flipper tricks
...
Function Vol(ball) ' Calculates the volume of the sound based on the ball speed
	Dim bvl : bvl = BallVel(ball) : Vol = Csng(bvl * bvl)
End Function
...
Function VolPlayfieldRoll(ball) ' Calculates the roll volume of the sound based on the ball speed
	VolPlayfieldRoll = RollingSoundFactor * 0.0005 * Csng(BallVel(ball) * BallVel(ball) * BallVel(ball))
End Function

Function PitchPlayfieldRoll(ball) ' Calculates the roll pitch of the sound based on the ball speed
	PitchPlayfieldRoll = BallVel(ball) * BallVel(ball) * 15
End Function
...
Dim brs_i
For brs_i = 0 To 19 : BallRollStr(brs_i) = "BallRoll_" & brs_i : Next
