...
Const BallSize = 50
Dim BS_d2 : BS_d2 = BallSize / 2    ' 50 is the normal size used in the core.vbs, VP kicker routines uses this value divided by 2
Const BallMass = 1     ' standard ball mass

'DOF config - (server config must be updated)
'100 Drain
'101 Left Flipper
'102 Right Flipper
'103
...
'114 
'115
'116 Left Ramp Target, first green target
'117 2nd green target
'118 3rd green target
'119 4th green target
'120 Right Targets
'121 Right kicker
'122 Center kicker
'123 BallRelease
...
Sub CheckTilt                                  'Called when table is nudged
    ...
    If Tilt> 15 Then 'If more that 15 then TILT the table
        Tilted = True
        DOF 130, DOFPulse 'activate motor/shaker when tilted
        'display Tilt
        DMDFlush
...
'    PlaySoundAt "fx_drain", Drain
	PlaySoundAt SoundFXDOF ("fx_drain", 100, DOFPulse, DOFContactors), Drain
...
Sub AwardExtraBall()
    If NOT bExtraBallWonThisBall Then
        DMD "_", CL(1, ("EXTRA BALL WON")), "_", eNone, eBlink, eNone, 1500, True, SoundFXDOF("fx_Knocker", 124, DOFPulse, DOFKnocker)
        DOF 121, DOFPulse
        ExtraBallsAwards(CurrentPlayer) = ExtraBallsAwards(CurrentPlayer) + 1
...
Sub AwardSpecial()
    DMD "_", CL(1, ("EXTRA GAME WON")), "_", eNone, eBlink, eNone, 1500, True, SoundFXDOF("fx_Knocker", 124, DOFPulse, DOFKnocker)
    DOF 121, DOFPulse
    Credits = Credits + 1
    If bFreePlay = False Then DOF 125, DOFOn
    LightEffect 2
...
'    PlaySoundAt "fx_droptarget", Target001
    PlaySoundAtBall SoundFXDOF("fx_droptarget", 116, DOFPulse, DOFTargets)
    If Tilted Then Exit Sub
...
'    PlaySoundAtBall "fx_droptarget"
    PlaySoundAtBall SoundFXDOF("fx_droptarget", 120, DOFPulse, DOFTargets)
    If Tilted Then Exit Sub
    PlaySound"DropTargets"
    bumper1L.State = 1
    Addscore DropValue
...
'    PlaySoundAtBall "fx_target"
    PlaySoundAtBall SoundFXDOF("fx_droptarget", 117, DOFPulse, DOFTargets)
    If Tilted Then Exit Sub
    PlaySound"LeftTargets"
    AddBonus 1
...
Sub Target008_Hit '3rd green target
    PlaySoundAtBall SoundFXDOF("fx_droptarget", 118, DOFPulse, DOFTargets)
'    PlaySoundAtBall "fx_target"
    If Tilted Then Exit Sub
    PlaySound"LeftTargets"
    AddBonus 1
...
'    PlaySoundAtBall "fx_target"
    PlaySoundAtBall SoundFXDOF("fx_droptarget", 119, DOFPulse, DOFTargets)
    If Tilted Then Exit Sub
    PlaySound"LeftTargets"
    AddBonus 1
...
'    PlaySoundAt "fx_kicker_enter", kicker001
	PlaySoundAt SoundFXDOF ("fx_kicker_enter", 134, DOFPulse, DOFContactors), kicker001 
...
'    PlaySoundAt "fx_kicker_enter", kicker002
	PlaySoundAt SoundFXDOF ("fx_kicker_enter", 121, DOFPulse, DOFContactors), kicker002
...
'    PlaySoundAt "fx_kicker_enter", kicker003
	PlaySoundAt SoundFXDOF ("fx_kicker_enter", 122, DOFPulse, DOFContactors), kicker003
