...
'   6. Eliminate ^2 in OnBallBallCollision — use x*x
'   7. Cache chgLamp locals in LampTimer
'   8. Pre-built ball rolling string array
' *********************************************************************
...
Function Distance(ax,ay,az,bx,by,bz)
	Dim dxd, dyd, dzd : dxd = ax - bx : dyd = ay - by : dzd = az - bz : Distance = SQR(dxd*dxd + dyd*dyd + dzd*dzd)
End Function
...
Dim BallRollStr() : ReDim BallRollStr(8)
Dim iii_br
For iii_br = 0 To 8 : BallRollStr(iii_br) = "fx_ballrolling" & iii_br : Next
Dim BallDropStr() : ReDim BallDropStr(8)
Dim iii_bd
For iii_bd = 0 To 8 : BallDropStr(iii_bd) = "fx_ball_drop" & iii_bd : Next
