...
'   2. Cache flipper COM props in LeftFlipper_Timer (currentangle/startangle/endangle)
'   3. Eliminate ^10 in AudioFade/Pan - chain multiply
'   4. Eliminate ^2 in Vol/BallVel - use x*x
'   5. Inline BallVel in RollingUpdate - cache ball COM props
'   6. COM property caching in RollingUpdate (BOT(b).X/Y/Z -> locals)
'   7. Pre-built string array for "fx_ballrolling" & b
'   8. Velocity ^2 in OnBallBallCollision - use v*v
'   9. Early-exit ball loops when no balls
'  10. Early-exit ball loops when no balls
' ****************************************************************
' ****************************************************************
